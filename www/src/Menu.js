...
Game5x.Menu.prototype = {
    ...
    preload: function () 
    {
        ...
        this.load.atlasJSONHash('diffTxt', 'asset/Theme'+this.theme+'/'+canvasHeight+'/buttons/diffTxt.png', 'asset/Theme'+this.theme+'/'+canvasHeight+'/buttons/diffTxt.json');
    ...
    settingsMenu:function(settingsBtn)
    {
        ...
        var ediff = this.add.sprite(this.world.centerX,this.world.centerY,'diffTxt');
        ediff.anchor.setTo(0.5,0.5);
        ediff.frame = 0;
        ediff.x = _1xBtn.x;
        ediff.y = _1xBtn.y + _1xBtn.height/2 + ediff.height/2;
        this.subMenu.add(ediff);

        var mdiff = this.add.sprite(this.world.centerX,this.world.centerY,'diffTxt');
        mdiff.anchor.setTo(0.5,0.5);
        mdiff.frame = 1;
        mdiff.x = _2xBtn.x;
        mdiff.y = _2xBtn.y + _2xBtn.height/2 + mdiff.height/2;
        this.subMenu.add(mdiff);

        var hdiff = this.add.sprite(this.world.centerX,this.world.centerY,'diffTxt');
        hdiff.anchor.setTo(0.5,0.5);
        hdiff.frame = 2;
        hdiff.x = _4xBtn.x;
        hdiff.y = _4xBtn.y + _4xBtn.height/2 + hdiff.height/2;
        this.subMenu.add(hdiff);

        var hdiffP = this.add.sprite(this.world.centerX,this.world.centerY,'diffTxt');
        hdiffP.anchor.setTo(0.5,0.5);
        hdiffP.frame = 2;
        hdiffP.x = pppmBtn.x;
        hdiffP.y = pppmBtn.y + pppmBtn.height/2 + hdiffP.height/2;
        this.subMenu.add(hdiffP);

        var ediffP = this.add.sprite(this.world.centerX,this.world.centerY,'diffTxt');
        ediffP.anchor.setTo(0.5,0.5);
        ediffP.frame = 0;
        ediffP.x = pmBtn.x;
        ediffP.y = pmBtn.y + pmBtn.height/2 + ediffP.height/2;
        this.subMenu.add(ediffP);
